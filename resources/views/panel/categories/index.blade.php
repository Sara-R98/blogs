                ...
                <div class=" bg-white table__box">
                    <table class="table">
                        ...
                        <tr role="row" class="">
                            ...
                            <td>
                                <a href="{{ route('categories.destroy' , $category->id) }}" onclick="destroyCategory(event , {{ $category->id }})" class="item-delete mlg-15" title="حذف"> حذف</a>
                                <a href="{{ route('categories.edit' , $category->id) }}" class="item-edit " title="ویرایش">ویرایش </a>
