                    ...
                    <div class="t-header-searchbox font-size-13">
                        <div type="text" class="text search-input__box font-size-13">جستجوی مقاله
                            <div class="t-header-search-content ">
                                ...
                                <button class="btn btn-webamooz_net">جستجو</btutton>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="bg-white table__box">
            <table class="table">
                ...
                <tr role="row" class="">
                    ...
                    <td>
                        <a href="{{ route('posts.destroy' , $post->id) }}" class="item-delete mlg-15" onclick="destroyPost(event , {{$post->id}})" title="حذف"> حذف </a>
                        <a href="" target="_blank" class="item-eye mlg-15" title="مشاهده"></a>
                        <a href="{{ route('posts.edit' , $post->id)}}" class="item-edit" title="ویرایش"> ویرایش</a>
